...
const BCAAs = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/bcaaProducts")
      .then((res) => {
      ...
      .catch((err) => console.error("Error fetching BCAA products:", err));
  }, []);
  ...
  const brands = ["Nutrabay", "Optimum Nutrition", "MuscleBlaze", "Scivation"];
    ...
    <div className="container py-5" style={{ backgroundColor: "#f5f5f5" }}>
      <div className="row">
        ...
        <div className="col-md-9">
          <h3 className="fw-bold mb-4 text-center">BCAA Products</h3>
          <div className="row g-4">
            {filteredProducts.map((product) => (
              <div className="col-6 col-md-4" key={product.id}>
                <Link
                  to={`/BCAADynamic/${product.id}`}
