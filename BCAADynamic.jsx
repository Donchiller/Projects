...
const flavors = ["Unflavored", "Chocolate Mint", "Vanilla"];
const weights = [
  "100 g (0.22 lb)",
  "150 g (0.33 lb)",
  "250 g (0.55 lb)",
...
const BCAADynamic = () => {
  ...
  const fetchDataById = async () => {
    try {
      const resp = await axios.get(`http://localhost:3000/bcaaProducts/${id}`);
