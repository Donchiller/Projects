...
const flavors = ["Herbal", "Spiced", "Mint"];
const weights = ["100 g (0.22 lb)", "250 g (0.55 lb)", "500 g (1.1 lb)"];

const AyurvedaDynamic = () => {
  const { id } = useParams();
  console.log("Ayurveda Product Id", id);
  ...
  const fetchDataById = async () => {
    try {
      const resp = await axios.get(
        `http://localhost:3000/ayurvedaProducts/${id}`
      );
          ...
          >
            ...
            <div className="mt-4 bg-light p-4 rounded shadow-sm">
              ...
              <div className="d-flex justify-content-between mb-3">
                <div className="text-warning display-6">4.8/5</div>
              ...
              <div className="text-muted mb-3">(800 Ratings & 200 Reviews)</div>
...
export default AyurvedaDynamic;
