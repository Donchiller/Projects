...
const flavors = ["Creamy", "Crunchy", "Natural"];
const weights = ["250 g (0.55 lb)", "500 g (1.1 lb)", "1 kg (2.2 lb)"];

const PeanutButterDynamic = () => {
  const { id } = useParams();
  console.log("Peanut Butter Id", id);
  ...
  const fetchDataById = async () => {
    try {
      const resp = await axios.get(
        `http://localhost:3000/peanutButterProducts/${id}`
      );
        ...
        <div className="col-8">
          ...
          >
            ...
            <div className="mt-4 bg-light p-4 rounded shadow-sm">
              ...
              <div className="text-muted mb-3">(300 Ratings & 75 Reviews)</div>
...
export default PeanutButterDynamic;
