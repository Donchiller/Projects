...
const flavors = ["Unflavoured", "Fruit Punch", "Blue Raspberry"];
const weights = [
  "100 g (0.22 lb)",
  "150 g (0.33 lb)",
  "250 g (0.55 lb)",
  ...
  const fetchDataById = async () => {
    try {
      const resp = await axios.get(
        `http://localhost:3000/preworkoutProducts/${id}`
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-4">
          <div>
            <img
              src={product.image || "/default-image.png"} // Adjust default image path
              alt={product.name}
              width={400}
              height={400}
          ...
          >
            ...
            <div className="mt-4 bg-light p-4 rounded shadow-sm">
              ...
              <div className="d-flex justify-content-between mb-3">
                <div className="text-warning display-6">4.5/5</div>
              ...
              <div className="text-muted mb-3">(500 Ratings & 150 Reviews)</div>
...
export default PreworkoutDynamic;
