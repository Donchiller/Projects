...
const flavors = ["unfalvoured", "Rich Chocolate Creme", "watermelon"];
...
function Creatinedynamic() {
  const { id } = useParams();
  console.log("Creatin Id", id);
  ...
  const fetchDataById = async () => {
    try {
      const resp = await axios.get(
        `http://localhost:3000/creatineProducts/${id}`
      );
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-4">
          ...
          >
            <img
              src={product.image || "/whey-image.png"}
              alt={product.name}
              width={400}
              height={400}
...
export default Creatinedynamic;
