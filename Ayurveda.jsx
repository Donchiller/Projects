...
const Ayurveda = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/ayurvedaProducts") // Update based on your JSON server
      .then((res) => {
  ...
  const categories = ["All", "Immunity", "Digestion", "Energy", "Skin Care"];
  const brands = ["Dabur", "Himalaya", "Patanjali", "Baidyanath"];
    ...
    <div className="container py-5" style={{ backgroundColor: "#f5f5f5" }}>
      <div className="row">
        ...
        <div className="col-md-9">
          <h3 className="fw-bold mb-4 text-center">Ayurveda Products</h3>
          <div className="row g-4">
            {filteredProducts.map((product) => (
              <div className="col-6 col-md-4" key={product.id}>
                <Link
                  to={`/AyurvedaDynamic/${product.id}`}
