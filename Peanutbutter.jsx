...
const Peanutbutter = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/peanutButterProducts") // Ensure your db.json has this endpoint
      .then((res) => {
  ...
  const categories = ["All", "Crunchy", "Creamy", "Natural", "Chocolate"];
  const brands = ["Pintola", "Alpino", "MYFITNESS", "Sundrop"];
    ...
    <div className="container py-5" style={{ backgroundColor: "#f5f5f5" }}>
      <div className="row">
        ...
        <div className="col-md-9">
          <h3 className="fw-bold mb-4 text-center">Peanut Butter Products</h3>
          <div className="row g-4">
            {filteredProducts.map((product) => (
              <div className="col-6 col-md-4" key={product.id}>
                <Link
                  to={`/PeanutButterDynamic/${product.id}`}
